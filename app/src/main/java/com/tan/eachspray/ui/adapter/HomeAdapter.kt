...
import com.eachspray.tan.tanbase.durationFormat
import com.eachspray.tan.tanbase.utils.ImageLoad
...
//                                        .into(imageView)
                                ImageLoad().load(feedImageUrl.toString(),imageView)
        ...
        //TextHeader
            ITEM_TYPE_TEXT_HEADER -> {
                ...
                //TODO
                var mRecyclerView = holder.getView<RecyclerView>(R.id.mIconRecyclerView)
                ...
                textList.add("未开放")
                textList.add("未开放")
                mRecyclerView.adapter = HomeIconAdapter(mContext, textList)
            }
...
//                .into(holder.getView(R.id.iv_cover_feed))
        ImageLoad().load(cover.toString(),holder.getView(R.id.iv_cover_feed))
        // 如果提供者信息为空，就显示默认
        if (avatar.isNullOrEmpty()) {
//            GlideApp.with(mContext)
//                    .load(defAvatar)
...
//                    .into(holder.getView(R.id.iv_avatar))
            ImageLoad().load(defAvatar.toString(),holder.getView(R.id.iv_avatar))
        } else {
//            GlideApp.with(mContext)
//                    .load(avatar)
//                    .placeholder(R.drawable.placeholder_banner).circleCrop()
...
//                    .into(holder.getView(R.id.iv_avatar))
            ...
            ImageLoad().load(avatar.toString(),holder.getView(R.id.iv_avatar))
        }
